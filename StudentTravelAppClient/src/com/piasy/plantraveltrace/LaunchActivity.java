...
import com.piasy.plantraveltrace.model.Setting;
...
public class LaunchActivity extends Activity
{
	...
	public boolean initEngineManager(Context context) 
	{
        ...
        {
        	Toast.makeText(PlanTravelTraceApplication.getInstance().getApplicationContext(), 
    ...
    public static class MyGeneralListener implements MKGeneralListener 
    {
        ...
        public void onGetNetworkState(int iError) 
        {
            ...
            {
            	Toast.makeText(PlanTravelTraceApplication.getInstance().getApplicationContext(), "你的网络出错啦！",
                        Toast.LENGTH_LONG).show();
            }
            else if (iError == MKEvent.ERROR_NETWORK_DATA) 
            {
            	Toast.makeText(PlanTravelTraceApplication.getInstance().getApplicationContext(), "输入正确的检索条件！",
                        Toast.LENGTH_LONG).show();
            }
            // ...
        }
        ...
        public void onGetPermissionState(int iError)
        {
            if (iError ==  MKEvent.ERROR_PERMISSION_DENIED) 
            {
                ...
                PlanTravelTraceApplication.getInstance().m_bKeyRight = false;
            }
        }
    }
